  ...
  return (
    <Wrapper>
      <div className="pricingContainer">
        <h1>Pricing built for all Creators</h1>
        ...
        <div className="priceSection">
          ...
          Get the complete Figma UI kit and style sheets to easily create your  next projects. "/>
          <PriceBox title="Businesses" price="$49" duration="month" promotion="+ 5$/employee" text="Experience our entire collection without limitations ! Get full access to our font families and to +30 images per project."/>
        </div>
      </div>
      {/* wave */}
      ...
      <section className="offerContainer">
        ...
        <p>Take advantage of our out-of-the-box features all included from the start of your subscription.</p>
